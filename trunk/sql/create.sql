...
create table Inscricao (id int8 not null, nota int2 not null, notaTF int2 not null, presencas int2 not null, turma_id int8 not null, aluno_id int8 not null, primary key (id), unique (turma_id, aluno_id))
create table Matricula (id int8 not null, data timestamp, numero int4 not null, status int4, curso_id int8 not null, aluno_id int8 not null, primary key (id), unique (aluno_id, curso_id), unique (numero))
