...
create table Curso (id int8 not null, cargaHoraria int2 not null, codCurso varchar(255) not null unique, nome varchar(255) not null unique, coordenador_id int8 not null, primary key (id))
...
create table Inscricao (id int8 not null, presencas int2 not null, turma_id int8 not null, aluno_id int8 not null, primary key (id), unique (turma_id, aluno_id))
create table Matricula (id int8 not null, numero int4 not null, aluno_id int8 not null, curso_id int8 not null, primary key (id), unique (aluno_id, curso_id), unique (numero))
create table Nota (id int8 not null, nome varchar(255) not null, nota int2 not null, inscricao_id int8 not null, primary key (id), unique (inscricao_id, nome))
...
create table Turma (id int8 not null, codigo varchar(255) not null, dataRegistro timestamp, disciplina_id int8 not null, primary key (id), unique (codigo, disciplina_id))
create table Usuario (DTYPE varchar(31) not null, id int8 not null, celular int8 not null, cep varchar(255), cidade varchar(255), cpf int8 unique, cursosComplementares varchar(255), dataExpRg timestamp, dataNascimento timestamp, email varchar(255) not null unique, enderecoRes varchar(255), formacaoAcademica varchar(255), historicoProfissional varchar(255), localNascimento varchar(255), login varchar(255) not null unique, nome varchar(255) not null unique, nomeMae varchar(255), rg int8 unique, senha varchar(255) not null, telefone int8 not null, uf varchar(255), carteiraTrabalho varchar(255) unique, primary key (id))
